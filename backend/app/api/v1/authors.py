...
async def create_author(author: schemas.AuthorCreate, db: DbSession):
...
async def update_author(author_id: UUID, author: schemas.AuthorCreate, db: DbSession):
...
async def delete_author(author_id: UUID, db: DbSession):
