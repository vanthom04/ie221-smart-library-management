...
export const CategoryStatsCard = ({ data }: CategoryStatsCardProps) => {
  ...
  return (
    <Card className="gap-0">
      ...
      <CardContent>
        {data.length === 0 ? (
          <div className="flex min-h-[300px] flex-1 flex-col items-center justify-center rounded-xl border border-dashed border-border p-6 text-center">
            <Inbox className="size-8 text-muted-foreground/50" />
            <p className="mt-2 text-sm font-medium text-foreground">
              Bạn chưa thêm thể loại yêu thích
            </p>
